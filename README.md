...
| GET    | /farmaceutico/{id}              | Obtém detalhes de um farmacêutico específico      | -                                                | `{ "farmaceutico": { "matricula": 1, "p_nome": "Dr. João", "u_nome": null,  "cpf": "123.456.789-00", "unidade_trabalho": null, "controle_farmacia": null } }` |
...
| GET    | /cliente/{id}                  | Obtém detalhes de um cliente específico           | -                                                | `{ "cliente": { "id": 1, "nome": "Carlos Silva", "cpf": "123.456.789-00" } }` |
